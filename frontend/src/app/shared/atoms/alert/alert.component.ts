...
export class AlertComponent {
  ...
  get variantClasses() {
    return {
      success: {
        container: 'border-green-200/80 bg-green-500/20',
        icon: 'text-green-500/80'
      },
      error: {
        container: 'border-rose-300/80 bg-rose-300/10',
        icon: 'text-rose-600/80'
      },
      warning: {
        container: 'border-yellow-200/80 bg-yellow-500/20',
        icon: 'text-yellow-500/80'
      },
      info: {
        container: 'border-blue-200/80 bg-blue-500/20',
